...
class ConnectionPool {
 public:
  ...
  class Handle {
   ...
   private:
    ...
    Handle(ConnectionPool* pool, size_t index, arrow::flight::FlightClient* client);
    // Overflow connection constructor.
    explicit Handle(std::unique_ptr<arrow::flight::FlightClient> overflow_client);
 ...
 private:
  ...
  arrow::Result<std::unique_ptr<arrow::flight::FlightClient>> createConnection();
